...
# Import SDK Blaxel secara internal dari paket yang terinstall
try:
    from blaxel.core.sandboxes import create_sandbox
except ImportError:
    try:
        from blaxel.core import create_sandbox
    except ImportError:
        print("[ERROR] Gagal mengimpor fungsi sandbox dari Blaxel SDK.")
        sys.exit(1)
...
def spawn_single_sandbox(cfg, account, slot_index):
    ...
    # Set Environment variable agar SDK mengenali API Key
...
def main():
    ...
    print(f"""
=============================================================
  ⚡ BLAXEL SRBMINER V3.6.5 AUTO-DEPLOYER (SDK CORE)
=============================================================
""")
